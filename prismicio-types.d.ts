...
/**
 * Item in *CaseStudies → Default → Primary → Company*
 */
export interface CaseStudiesSliceDefaultPrimaryCompanyItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Company*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.company[].case_study
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Company field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.company[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  company: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryCompanyItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryCompanyItem,
