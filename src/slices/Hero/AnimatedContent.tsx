...
export default function AnimatedContent({slice}: {slice: Content.HeroSlice}) {
    ...
    useGSAP(() => {
        // If the user prefers reduced motion, skip animations ( change in the browser settings )
        ...
        tl.fromTo(".hero__glow", {scale: 0.5}, {scale: 1, opacity: 1, duration: 1.8}, "-=1.0");
    ...
    <div className="relative" ref={container}>
        ...
        {isFilled.image(slice.primary.image) && (
          <div className="hero__image glass-container mt-16 w-fit opacity-0">
            <div className="hero__glow absolute inset-0 -z-10 bg-blue-500/40 blur-2xl filter opacity-0"/>
